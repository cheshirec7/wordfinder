$(document).ready(function () {
    ...
    function showWordDefModal(word) {
        ...
        $.ajax({
            type: 'GET',
            url: '//phpwordfinder.erictotten.org/define/' + word,
            dataType: 'html'
    ...
    function doSearch(findButtonClicked) {
        ...
        let startTime = new Date(),
            oInput = {},
            return_type = 'html',
            findurl = '//wordfinder.erictotten.org/find',
        ...
        switch (backend) {
            case 0:
                findurl = '//gowordfinder.appspot.com/find';
                break;
            case 1:
                findurl = '//nodewordfinder.herokuapp.com/find';
                break;
            case 2:
                findurl = '//phpwordfinder.erictotten.net/find';
                break;
            case 3:
                findurl = '//pywordfinder.appspot.com/search';
                break;
        }
